...
/*  Model used to store our Receipt. This conforms to Objectso Realm can insert into the database.
 
    This allows a code-first rather than database-design first approach.
 
    If a different database approach is required, then the model can simply ignore the Realm import and use a proper Database controller.
 */
